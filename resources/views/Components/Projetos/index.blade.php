<section class="projetos" id="Projetos">
    ...
    <p class="subtitle">Aqui estão alguns dos projetos mais recentes em que estive envolvido e que desenvolvi de forma
        independente</p>
    <br>

    <div class="container py-5">
        <div class="main-timeline-2" data-anime="right">
            <div class="timeline-2 left-2">
                <a class="link" href="https://www.lzrtransportes.com.br/" target="_blank">
                    <div class="card ">
                        <img src="{{ asset('site/projetos/lzr.jpeg') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0 job-description">Landing page elaborado para a promoção de uma
                                ...
                                carga em todo o estado de São Paulo.</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="timeline-2 right-2">
                <a class="link" href="https://codeknight.com.br/" target="_blank">
                    <div class="card">
                        <img src="{{ asset('site/projetos/code.jpg') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0 job-description">Landing page criada com o propósito de promover uma
                                inovadora startup de tecnologia, apresentando de forma abrangente suas soluções e
                                serviços inovadores.</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="timeline-2 left-2" data-anime="left">
                <a class="link" href="https://gabrielachaluppe.com/" target="_blank">
                    <div class="card">
                        <img src="{{ asset('site/projetos/gabriella.jpg') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-4 job-description"><i class="far fa-clock" aria-hidden="true"
                                                               style="text-align: center !important; color: #fff"></i>
                                2021</p>
                            <p class="mb-0 job-description">Landing page criado para a captação eficaz de leads e ampla
                                divulgação dos serviços no âmbito do direito penal.</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="timeline-2 right-2" data-anime="right">
                <a class="link" href="https://supportsus.com.br/" target="_blank">
                    <div class="card">
                        <img src="{{ asset('site/projetos/supportsus.jpg') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
            ...
            <div class="timeline-2 left-2" data-anime="left">
                <a class="link" href="https://sgasupportsus.netlify.app" target="_blank">
                    <div class="card">
                        <img src="{{ asset('site/projetos/sistema.jpg') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0 job-description">Sistema Avançado de Gerenciamento de Atendimento para
                                Unidades
                                Básicas de Saúde. Oferece um fluxo completo para pacientes, incluindo emissão
            ...
            <div class="timeline-2 right-2" data-anime="right">
                ...
                <a class="link" href="https://bartho.org.br/" target="_blank">
                    <div class="card">
                        <img src="{{ asset('site/projetos/bartho.png') }}" alt="Card image cap"
                             loading="lazy">
                        <div class="card-body p-4">
    ...
    <div class="container py-5 projetos_mobile">
        <div class="row">
            <div class="col-xs-8 col-sm-6 col-md-12 col-lg-6">
                <a class="link" href="https://www.lzrtransportes.com.br/" target="_blank">
                    <div class="card mb-4">
                        <img src="{{ asset('site/projetos/lzr.jpeg') }}" alt="Card image cap" loading="lazy">
                        <div class="card-body p-4">
                            <h4 class="fw-bold mb-4">Transportadora Lanzara</h4>
            ...
            <div class="col-xs-8 col-sm-6 col-md-12 col-lg-6">
                <a class="link" href="https://codeknight.com.br/" target="_blank">
                    <div class="card mb-4">
                        <img src="{{ asset('site/projetos/code.jpg') }}" alt="Card image cap" loading="lazy">
                        <div class="card-body p-4">
                            <h4 class="fw-bold mb-4">Code Knight</h4>
            ...
            <div class="col-xs-8 col-sm-6 col-md-12 col-lg-6">
                <a class="link" href="https://gabrielachaluppe.com/" target="_blank">
                    <div class="card mb-4">
                        <img src="{{ asset('site/projetos/gabriella.jpg') }}" alt="Card image cap" loading="lazy">
                        <div class="card-body p-4">
                            <h4 class="fw-bold mb-4">Dr Gabriella Chaluppe</h4>
            ...
            <div class="col-xs-8 col-sm-6 col-md-12 col-lg-6">
                <a class="link" href="https://supportsus.com.br/" target="_blank">
                    <div class="card mb-4">
                        <img src="{{ asset('site/projetos/supportsus.jpg') }}" alt="Card image cap" loading="lazy">
                        <div class="card-body p-4">
                            <h4 class="fw-bold mb-4">SUPPORT</h4>
                            <p class="mb-4 job-description">2023</p>
                            <p class="mb-0 job-description">Landing page "Support", uma marca dedicada a fornecer
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    <path fill="#0c102a" fill-opacity="1"
          d="M0,96L48,117.3C96,139,192,181,288,170.7C384,160,480,96,576,64C672,32,768,32,864,32C960,32,1056,32,1152,32C1248,32,1344,32,1392,32L1440,32L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
</svg>
